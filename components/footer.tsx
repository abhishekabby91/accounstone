...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary text-white">
      {/* ── Top band: logo, tagline, contact, social ── */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 md:gap-16 items-start">
          ...
          <ul className="space-y-3 text-sm text-white/70 md:text-right">
            <li className="flex items-center gap-3 md:flex-row-reverse">
              ...
              <a href={`mailto:${companyInfo.contact.email}`} className="hover:text-white transition-colors break-all">{companyInfo.contact.email}</a>
            </li>
            <li className="flex items-center gap-3 md:flex-row-reverse">
              <Phone size={16} className="shrink-0 text-white/45" aria-hidden="true" />
              <a href={`tel:${companyInfo.contact.phone}`} className="hover:text-white transition-colors">+91 99905 97192</a>
            </li>
            <li className="flex items-center gap-3 md:flex-row-reverse">
