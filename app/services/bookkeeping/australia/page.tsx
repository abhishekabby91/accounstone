...
export const metadata: Metadata = genMeta({
  title: 'Outsourced Bookkeeping for Australian Accounting Firms',
...
export default function BookkeepingAUPage() {
  return (
    <main>
      ...
      <section className="w-full py-8 md:py-12 px-6 md:px-8 bg-white"><Reveal className="max-w-4xl mx-auto space-y-6"><><div className="space-y-2"><span className="text-sm font-semibold tracking-wide uppercase text-accent">Overview</span><h2 className="font-serif text-2xl md:text-3xl font-bold text-primary text-balance">Books That Hold Up at BAS Time</h2></div><p className="text-lg text-muted leading-relaxed">{overview}</p></></Reveal></section>
