...
export default function AuditSupportAUPage() {
  return <main>
    ...
    <section className="w-full py-8 md:py-12 px-6 md:px-8 bg-white"><Reveal className="max-w-4xl mx-auto space-y-6"><><span className="text-sm font-semibold tracking-wide uppercase text-accent">Overview</span><h2 className="text-2xl md:text-3xl font-bold text-primary text-balance">The 30 June Squeeze Is the Real Problem</h2><p className="text-lg text-muted leading-relaxed">{overview}</p></></Reveal></section>

    <section className="w-full py-8 md:py-12 px-6 md:px-8 bg-input"><div className="max-w-5xl mx-auto"><Reveal className="text-center space-y-4 mb-12"><><span className="text-sm font-semibold tracking-wide uppercase text-accent">Across the cycle</span><h2 className="text-2xl md:text-3xl font-bold text-primary text-balance">Where Preparation Support Fits the Australian Audit Year</h2></></Reveal>
    ...
    <section className="w-full py-12 md:py-16 px-6 md:px-8 bg-input"><div className="max-w-5xl mx-auto text-center"><h2 className="text-3xl font-bold text-primary mb-5">Keep the Australian service cluster connected</h2>
