      ...
      <section className="w-full py-20 md:py-28 px-6 md:px-8 bg-white">
        <Reveal className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-primary text-balance">What Makes Texas Different</h2>
          </div>
      ...
      <section className="w-full py-20 md:py-28 px-6 md:px-8 bg-input">
        <div className="max-w-5xl mx-auto">
          <Reveal className="text-center space-y-4 mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-primary text-balance">Built Around Texas Specifics</h2>
            </>
          </Reveal>
