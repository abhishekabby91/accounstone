    ...
    >
      ...
      <div className="mt-8 p-6 bg-input rounded-xl border border-border/70">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/services/accounts-payable/united-states" className="px-4 py-2 rounded-lg bg-white border border-border text-primary text-sm font-medium hover:bg-border transition-colors">Accounts Payable Support</Link>
